    ...
    <div className="min-h-screen bg-surface-page py-10 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-surface-card rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="space-y-2">
                {assetLinks.map((link, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    />
                    {assetLinks.length > 1 && (
                      <button type="button" onClick={() => removeLink(i)} className="text-slate-400 hover:text-accent-crimson transition-colors">
              ...
              <div className="space-y-2">
                {subtasks.map((task, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    />
                    {subtasks.length > 1 && (
                      <button type="button" onClick={() => removeSubtask(i)} className="text-slate-400 hover:text-accent-crimson transition-colors">
                        <Trash2 className="w-4 h-4" />
                      </button>
                    )}
                  </div>
          ...
          {/* Footer */}
          <div className="flex items-center justify-between px-6 py-4 border-t border-slate-100 bg-surface-nested">
