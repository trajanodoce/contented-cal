...
function FieldInput({ field, value, onChange }: {
  ...
  const cls = "w-full px-3 py-2.5 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition-colors";
