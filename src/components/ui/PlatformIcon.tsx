...
const PLATFORM_CONFIG: Record<ExternalLinkPlatform, PlatformConfig> = {
  ...
  granola: {
    bg: '#E8F5EE',
    border: 'rgb(var(--color-state-success) / 0.125)',
    icon: (s) => (
      <svg width={s} height={s} viewBox="0 0 24 24" fill="none" style={{ stroke: 'rgb(var(--color-state-success))' }} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
