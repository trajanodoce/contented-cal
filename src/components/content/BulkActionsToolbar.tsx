    ...
    <>
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-surface-card shadow-xl rounded-xl px-4 py-3" style={{ border: '1px solid #00233930' }}>
        ...
        <div ref={assignRef} className="relative">
          ...
          {showAssignDropdown && (
            <div className="absolute bottom-full mb-1 left-0 bg-surface-card rounded-xl shadow-xl min-w-[200px] max-h-[300px] overflow-y-auto" style={{ border: '1px solid #00233930', background: 'linear-gradient(135deg, #005D9718 0%, transparent 50%), #ffffff' }}>
              <div className="p-2">
        ...
        <div ref={statusRef} className="relative">
          ...
          {showStatusDropdown && (
            <div className="absolute bottom-full mb-1 left-0 bg-surface-card rounded-xl shadow-xl min-w-[180px]" style={{ border: '1px solid #00233930', background: 'linear-gradient(135deg, #005D9718 0%, transparent 50%), #ffffff' }}>
              <div className="p-2">
